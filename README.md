...
Note: Attempting to build the Docker container on Windows ARM64 will fail because there is no pyqt5 wheel. Use the prebuilt binary from [releases](https://github.com/ViciousSquid/Dosidicus/releases/tag/v2.6.2.0) instead
