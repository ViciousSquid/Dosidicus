...
translations = {
    ...
    # ===== NEUROGENESIS LOGS =====
    "log_created": "{time} - une neurone {type} ({name}) a été créée car le compteur {type} était à {value}",
    ...
    "designer_status_selected": "Sélection : {source} → {target} (poids : {weight})",
    "designer_status_weight_updated": "Poids mis à jour : {source} → {target} = {weight}",
    ...
    "about_numpy_no_onnx": "NumPy (ONNX indisponible)",
    "ago_hours": "il y a {n} h",
    "ago_minutes": "il y a {n} min",
    "ago_seconds": "il y a {n} s",
    "auto_decline": "(Refus automatique dans {seconds} s)",
    "banner_bindings_loaded": "🔗 Liaisons chargées :",
    "banner_system_notification": "⚠️ Notification système",
    "bt_btn_export_assoc": "Exporter les associations",
    "bt_chk_capture_training": "Capturer les données d'entraînement",
    "bt_chk_show_explanation": "Afficher l'explication",
    "bt_chk_training_overview": "Afficher l'aperçu du processus d'entraînement",
    "bt_decision_made": "Décision prise : {decision}",
    "bt_lbl_decision_history": "Historique des décisions :",
    "bt_lbl_decision_inputs": "Entrées de la décision :",
    "bt_lbl_learned_assoc": "Associations apprises :",
    "bt_lbl_personality": "Personnalité : {personality}",
    "bt_learning_active": "État de l'apprentissage : actif",
    "bt_learning_inactive": "État de l'apprentissage : inactif",
    "bt_msg_clear_log": "Voulez-vous vraiment effacer le journal d'activité de l'apprentissage ?",
    "bt_msg_clear_log_title": "Effacer le journal",
    "bt_msg_designer_missing": "Module Concepteur de Cerveau introuvable.",
    "bt_msg_export_assoc": "Associations exportées vers {path}",
    "bt_msg_export_default_files": "Données d'apprentissage exportées vers « weight_changes.txt » et « learning_data.csv »",
    "bt_msg_export_err": "Erreur lors de l'export des données : {error}",
    "bt_msg_export_err_title": "Erreur d'export",
    "bt_msg_export_learning": "Données d'apprentissage exportées vers {path}",
    "bt_msg_export_ok_title": "Export réussi",
    "bt_msg_export_tab": "Contenu de l'onglet Apprentissage exporté vers {path}",
    "bt_msg_neurogenesis_err": "Erreur de neurogenèse : {error}",
    "bt_msg_no_brain_window": "La fenêtre du cerveau n'est pas initialisée",
    "bt_msg_no_neurons": "Aucun nouveau neurone créé — consultez la console pour les détails",
    "bt_msg_settings_applied": "Les paramètres de neurogenèse ont été mis à jour avec succès.",
    "bt_msg_settings_title": "Paramètres appliqués",
    "bt_paused": "EN PAUSE",
    "bt_processing_decision": "Traitement de la décision ({ms} ms)...",
    "bt_seconds": "{seconds} secondes",
    "clear": "Effacer",
    "conf_confident": "Confiant",
    "conf_decisive": "Décidé",
    "conf_fairly_sure": "Assez sûr",
    "conf_leaning": "Penche vers",
    "conf_torn": "Hésitant",
    "confidence": "Confiance",
    "dec_awaiting": "En attente de la première décision…",
    "dec_base_drive": "Pulsion de base",
    "dec_behaviour": "Comportement : « {behaviour} »",
    "dec_can_see": "PEUT VOIR",
    "dec_final_score": "Score final",
    "dec_latest_caption": "dernière → {action}   (la plus ancienne … la plus récente)",
    "dec_no_history": "Aucune décision enregistrée pour l'instant.",
    "dec_no_winner": "Aucune gagnante notée à détailler.",
    "dec_personality_chance": "Personnalité et hasard",
    "dec_sec_candidates": "Actions candidates",
    "dec_sec_candidates_desc": "Chaque action notée par le moteur à ce tick. La barre est le score final ; le repère pâle indique le score de base avant mémoire / urgence / personnalité.",
    "dec_sec_drives": "Pulsions et perception actuelles",
    "dec_sec_drives_desc": "Les besoins internes qui alimentent les scores ci-dessus, et ce que le calmar peut voir.",
    "dec_sec_history": "Décisions récentes",
    "dec_sec_history_desc": "Un bloc par choix récent — la couleur est l'action, la hauteur la confiance.",
    "dec_sec_pipeline": "Comment la gagnante a été notée",
    "dec_sec_pipeline_desc": "Le score de l'action gagnante, de la pulsion de base au score final.",
    "dec_sec_thoughts": "Pensées du calmar",
    "dec_sec_thoughts_desc": "Narration en direct émise à mesure que le calmar perçoit et réagit.",
    "designer_act_binary": "Neurone binaire (Marche/Arrêt)",
    "designer_act_continuous": "Activation (0-100)",
    "designer_act_high": "Élevé",
    "designer_act_low": "Faible",
    "designer_act_max": "Max",
    "designer_act_mid": "Moyen",
    "designer_act_min": "Min",
    "designer_act_off": "ARRÊT (0)",
    "designer_act_on": "MARCHE (100)",
    "designer_act_title": "Activation : {name}",
    "designer_action_gen_dialog": "🎲 Générer...",
    "designer_action_return": "Enregistrer et revenir au jeu",
    "designer_binding_btn_pick_colour": "Choisir une couleur...",
    "designer_binding_btn_reset_colour": "Réinitialiser (aléatoire)",
    "designer_binding_grp_params": "Paramètres du comportement",
    "designer_binding_lbl_tint": "Couleur de teinte :",
    "designer_binding_never_driven": "⚠ {display}  (aucune entrée : l'activation ne change jamais)",
    "designer_binding_tooltip_cool": "Délai minimal entre deux déclenchements",
    "designer_binding_tooltip_thresh": "Niveau d'activation requis pour déclencher la sortie",
    "designer_btn_return": "💾 Enregistrer et revenir au jeu",
    "designer_filter_json": "JSON (*.json)",
    "designer_gen_btn_apply": "✨ Générer et appliquer",
    "designer_gen_btn_preview": "🔄 Aperçu de la génération",
    "designer_gen_chk_clear": "Effacer les connexions existantes",
    "designer_gen_chk_feedback": "Inclure les boucles de rétroaction",
    "designer_gen_count": "{total} connexions ({excitatory} excitatrices, {inhibitory} inhibitrices)",
    "designer_gen_dlg_desc": "Crée des connexions d'inspiration biologique entre les 8 neurones obligatoires.\nChaque génération est unique grâce au bruit aléatoire.",
    "designer_gen_dlg_header": "Générer des connexions neuronales aléatoires",
    "designer_gen_dlg_title": "🎲 Générer un réseau clairsemé",
    "designer_gen_grp_preset": "Style prédéfini",
    "designer_gen_grp_preview": "Aperçu",
    "designer_gen_grp_tuning": "Réglage fin",
    "designer_gen_lbl_density": "Densité :",
    "designer_gen_lbl_noise": "Bruit des poids :",
    "designer_gen_lbl_sensor_prob": "Prob. de capteurs :",
    "designer_gen_lbl_variance": "Variance de pos. :",
    "designer_gen_note_sensors": "NOTE : tentera d'ajouter des capteurs aléatoires (prob. : {value})",
    "designer_gen_note_variance": "NOTE : perturbera les positions au hasard (var. : {value})",
    "designer_gen_preview_empty": "Aucune connexion ne serait créée avec ces réglages.",
    "designer_gen_tip_clear": "Supprimer toutes les connexions existantes avant de générer",
    "designer_gen_tip_density": "Plus bas = moins de connexions, plus haut = plus de connexions",
    "designer_gen_tip_feedback": "Autoriser les connexions bidirectionnelles là où c'est biologiquement plausible",
    "designer_gen_tip_noise": "Quantité d'aléatoire dans les poids des connexions",
    "designer_gen_tip_sensor_prob": "Probabilité d'ajouter des capteurs supplémentaires au hasard",
    "designer_gen_tip_variance": "Décaler les positions des neurones (0,0 = fixes, 0,5 = chaotiques)",
    "designer_msg_bridge_write_fail": "Impossible d'écrire le fichier passerelle.",
    "designer_msg_clear_out_confirm_title": "Effacer les liaisons de sortie",
    "designer_msg_export_failed_title": "Échec de l'export",
    "designer_msg_game_not_found": "Dosidicus ne semble pas être en cours d'exécution.\nLancez le jeu pour envoyer des conceptions.",
    "designer_msg_game_not_found_title": "Jeu introuvable",
    "designer_msg_generate_fail": "Échec de la génération : {error}",
    "designer_msg_push_fail": "Impossible d'envoyer la conception :\n{error}",
    "designer_msg_pushed_brain": "Le cerveau personnalisé a été envoyé depuis le Concepteur",
    "designer_output_warn_missing": "La liaison référence un neurone inexistant : {neuron}",
    "designer_output_warn_never_driven": "« {neuron} » n'a aucune connexion entrante ; son activation ne peut donc jamais changer et cette liaison ne se déclenchera pas.",
    "designer_preset_item": "{name} - {description}",
    "designer_status_pushed": "Conception envoyée au jeu en cours",
    "designer_status_report": "Neurones : {total}\n  • Obligatoires : {required}\n  • Capteurs : {sensors}\n  • Personnalisés : {custom}\n\nConnexions : {connections}\nCouches : {layers}\n",
    "designer_status_report_outputs": "Liaisons de sortie : {count} ({enabled} activées)\n",
    "designer_tb_open": "📂 Ouvrir",
    "designer_tb_push": "🚀 Envoyer au jeu",
    "designer_tb_save": "💾 Enregistrer",
    "designer_tb_templates": "📋 Modèles",
    "designer_tooltip_binary": "[Binaire : 0 ou 100]",
    "designer_tooltip_from_plugin": "[Du plugin : {plugin}]",
    "designer_tooltip_plugin": "[Plugin : {plugin}]",
    "designer_tooltip_push": "Exporter la conception actuelle directement vers le jeu Dosidicus en cours",
    "designer_tooltip_return": "Enregistrer les modifications et revenir à la vue du jeu",
    "dlg_balance_report": "Rapport d'équilibre des connexions",
    "dlg_btn_export_log": "Exporter le journal",
    "dlg_btn_save_selected": "Enregistrer la sélection",
    "dlg_clear_logs": "Voulez-vous vraiment effacer tous les journaux de décisions ?",
    "dlg_clear_logs_title": "Effacer les journaux",
    "dlg_col_state": "État",
    "dlg_col_strength": "Force",
    "dlg_grp_activity": "Historique d'activité",
    "dlg_grp_health_history": "Historique de santé",
    "dlg_grp_neuron_info": "Informations sur le neurone",
    "dlg_grp_weakest": "Connexions les plus faibles",
    "dlg_health_title": "Diagnostic de santé du réseau",
    "dlg_health_trend": "TENDANCE DE SANTÉ :",
    "dlg_invalid_range": "{neuron} doit être compris entre 0 et 100",
    "dlg_invalid_value": "Valeur invalide",
    "dlg_lbl_current_state": "État actuel :",
    "dlg_learning_log": "Journal d'apprentissage",
    "dlg_log_exported": "Journal exporté vers {path}",
    "dlg_logs_cleared": "Tous les journaux de décisions ont été effacés.",
    "dlg_logs_cleared_title": "Journaux effacés",
    "dlg_neuron_activity_report": "Rapport d'activité neuronale",
    "dlg_no_decisions_selected": "Aucune décision sélectionnée à enregistrer.",
    "dlg_overactive": "NEURONES HYPERACTIFS :",
    "dlg_recent_decisions": "Décisions récentes",
    "dlg_save_decisions_title": "Enregistrer les décisions sélectionnées",
    "dlg_save_ok": "Décisions sélectionnées enregistrées dans {path}",
    "dlg_save_ok_title": "Enregistrement réussi",
    "dlg_tab_balance": "Équilibre",
    "dlg_thought_summary": "Heure : {time} - Décision : {decision}",
    "dlg_unbalanced": "CONNEXIONS DÉSÉQUILIBRÉES :",
    "dlg_underactive": "NEURONES HYPOACTIFS :",
    "dlg_validation_error": "Erreur de validation",
    "dlg_validation_error_msg": "Une erreur s'est produite pendant la validation : {error}",
    "health_low_density": "Faible densité",
    "health_optimal": "Optimale",
    "inspector_activity_soon": "Journalisation et graphiques détaillés de l'activité à venir.",
    "inspector_na": "N/D",
    "inspector_no_neuron": "Aucun neurone sélectionné",
    "inspector_no_state": "Aucun état particulier capturé.",
    "inspector_tab_activity": "Activité",
    "inspector_tab_overview": "Vue d'ensemble",
    "inspector_tip_combo": "Sélectionnez un neurone à inspecter ou cliquez-en un dans le visualiseur.",
    "inspector_unknown": "Inconnu",
    "knowledge_ask_prefix": "Que sait le calmar à propos de",
    "knowledge_ask_suffix": "?",
    "knowledge_btn_export": "Exporter…",
    "knowledge_btn_refresh": "Actualiser",
    "knowledge_capability_blurb": "Un neurone est créé lorsque le réseau présente une carence fonctionnelle persistante qu'il ne peut pas combler avec la structure dont il dispose déjà — et non parce qu'un événement particulier s'est produit. Voici ce diagnostic, en direct.",
    "knowledge_col_change": "Changement",
    "knowledge_col_evidence": "Preuves",
    "knowledge_col_from": "De",
    "knowledge_col_mechanism": "Mécanisme",
    "knowledge_col_to": "Vers",
    "knowledge_col_when": "Quand",
    "knowledge_confidence": "confiance {confidence}",
    "knowledge_cooldown": "Temps de recharge de la croissance : {seconds} s restantes.",
    "knowledge_empty": "Le calmar n'a encore rien appris. Ses synapses sont toujours celles avec lesquelles il est né.",
    "knowledge_empty_topic": "Le calmar n'a encore rien appris à propos de <b>{topic}</b>. Tout ce qu'il sait vient de l'expérience, alors donnez-lui-en.",
    "knowledge_evidence_after": "après qu'il a {action}",
    "knowledge_export_deficits": "Ce qu'il ne sait pas encore faire",
    "knowledge_export_done": "{count} élément(s) écrit(s) dans {path}",
    "knowledge_export_done_title": "Exporté",
    "knowledge_export_fail_title": "Échec de l'export",
    "knowledge_export_filter": "Fichiers texte (*.txt)",
    "knowledge_export_head": "Ce que sait ce calmar",
    "knowledge_export_title": "Exporter ce que sait le calmar",
    "knowledge_grown": "Structure créée jusqu'ici",
    "knowledge_lbl_neuron": "Neurone :",
    "knowledge_lbl_synapse": "Synapse :",
    "knowledge_ledger_error": "Impossible de lire le registre : {error}",
    "knowledge_monitor_error": "Impossible de lire le moniteur : {error}",
    "knowledge_neuron_error": "Impossible d'expliquer ce neurone : {error}",
    "knowledge_no_deficits": "Le réseau peut actuellement représenter, réguler et exprimer tout ce qu'il a rencontré. Rien à faire croître.",
    "knowledge_no_monitor": "Ce cerveau n'a pas de moniteur de capacités.",
    "knowledge_no_provenance": "Ce cerveau ne conserve aucune provenance.",
    "knowledge_remedy": "Un nouveau neurone servirait à : {remedy}",
    "knowledge_remedy_default": "y remédier",
    "knowledge_row_action": "Quelle action était impliquée",
    "knowledge_row_behaviour": "Comment cela a influencé le comportement",
    "knowledge_row_consequence": "Quelle conséquence a suivi",
    "knowledge_row_experience": "Quelle expérience l'a provoqué",
    "knowledge_row_reason": "Pourquoi la connexion a changé",
    "knowledge_severity": "gravité {severity}",
    "knowledge_status_ready": "prêt à faire croître la structure",
    "knowledge_status_shrinking": "; l'apprentissage ordinaire la réduit déjà",
    "knowledge_status_watching": "en observation — vue {observations} fois sur {age} s",
    "knowledge_stood_down": "Envisagé puis écarté",
    "knowledge_strength": "force {strength}",
    "knowledge_subtab_capability": "Ce qu'il ne sait pas encore faire",
    "knowledge_subtab_knows": "Ce qu'il sait",
    "knowledge_subtab_neuron": "Pourquoi ce neurone ?",
    "knowledge_subtab_weight": "Pourquoi ce poids ?",
    "knowledge_summary": "{changes} changements synaptiques enregistrés sur {synapses} synapses · {grown} neurones créés, {pruned} élagués · {episodes} expériences mémorisées · {contingencies} choses qu'il a comprises sur ses propres actions",
    "knowledge_tip_export": "Enregistrer tout ce que sait le calmar, en langage clair",
    "knowledge_topic_placeholder": "n'importe quoi… essayez « nourriture », « anxiété », « plante »",
    "knowledge_weight_error": "Impossible d'expliquer cette synapse : {error}",
    "lab_card_error": "Impossible de lire ceci",
    "lab_card_identity": "Qu'est-ce que c'est ?",
    "lab_conn_decisive": "de façon décisive",
    "lab_conn_down": "vers le bas",
    "lab_conn_driven": "Ce qui le pilote",
    "lab_conn_drives": "Ce qu'il pilote",
    "lab_conn_external": "Rien ne pilote ce neurone par une synapse, et rien ne le peut : le monde l'écrit à chaque tick, si bien qu'une synapse pointant vers lui serait écrasée avant que quiconque puisse lire ce qu'elle y a déposé.",
    "lab_conn_faintly": "faiblement",
    "lab_conn_in": "Le fait que <b>{other}</b> soit au-dessus de son niveau de repos pilote ce neurone {direction}, {strength} (poids {w}).",
    "lab_conn_moderately": "modérément",
    "lab_conn_more": "...et {n} de plus",
    "lab_conn_none": "Il n'a aucune synapse. Rien ne peut le piloter et il ne peut rien piloter, donc ce qu'il calcule reste sur place. Le moniteur de capacités compte cela comme une carence, et le cerveau fera croître un connecteur pour le raccrocher au réseau.",
    "lab_conn_out": "Quand <b>{me}</b> est au-dessus de son niveau de repos, il pousse <b>{other}</b> {direction}, {strength} (poids {w}) ; en dessous du repos, il fait l'inverse.",
    "lab_conn_strongly": "fortement",
    "lab_conn_title": "Que signifient ses connexions ?",
    "lab_conn_up": "vers le haut",
    "lab_conn_why": "L'essentiel de cette valeur ({amount:+.2f}) vient de {reason}.",
    "lab_history_none": "Rien n'a encore modifié la moindre synapse de ce neurone.",
    "lab_history_title": "Ce qui a changé ici, et pourquoi",
    "lab_identity_deficit": "<span style='color:#b7791f;'>Il fait partie d'un problème que le cerveau n'a pas résolu :</span> {summary}.",
    "lab_identity_now": "En ce moment il indique <b>{value:.0f}</b> - {reading}.",
    "lab_identity_spec": "C'est un neurone <b>{spec}</b>, et il a été significativement actif {count} fois depuis sa naissance.",
    "lab_identity_strength": "Il a été renforcé à <b>{mult:.1f}x</b>, parce que le cerveau a rencontré le même type de problème et n'avait plus de place pour faire croître un autre neurone.",
    "lab_influence_contingency": "Le calmar croit que {action} fait aller {stat} {direction} d'environ {effect:.0f} points ({conf:.0%} de confiance, après {n} observation(s)).",
    "lab_influence_indirect": "Il ne touche pas directement la physiologie du calmar. Ce qu'il apporte atteint le comportement par les neurones qu'il pilote.",
    "lab_influence_now": "À son activation actuelle, et si rien d'autre ne changeait, voici ce qu'il apporterait à chacune de ses cibles au prochain tick :",
    "lab_influence_pending": "Il possède des synapses vers la physiologie du calmar mais n'a pas encore été assez actif pour en bouger quoi que ce soit. La modulation est volontairement douce : une source saturée passant par une synapse maximale apporte environ 0,15 point par tick.",
    "lab_influence_row": "Il a poussé <b>{other}</b> de {total:+.2f} points au total, sur {ticks} tick(s) où il faisait quelque chose.",
    "lab_influence_title": "Qu'a-t-il fait réellement ?",
    "lab_meaning_action": "pendant que le calmar est en train de <b>{what}</b>",
    "lab_meaning_clear": "nette",
    "lab_meaning_down": "descend à {inside:.0f}",
    "lab_meaning_lead": "Mesuré à partir du comportement réel de ce neurone, et non de la raison pour laquelle il a été créé. Le nombre est le <i>d</i> de Cohen : l'écart entre son activation quand la situation se présente et quand elle ne se présente pas. C'est la statistique même que la neurogenèse utilise pour décider si le cerveau sait distinguer une situation.",
    "lab_meaning_none": "Rien pour l'instant, autant que les statistiques du calmar puissent le dire. Ce neurone ne se comporte pas de manière mesurablement différente dans une situation que le calmar rencontre régulièrement : il ne représente donc aucune d'entre elles. Il est peut-être trop jeune, ou il transporte simplement du signal d'un endroit à un autre.",
    "lab_meaning_otherwise": "(sinon {outside:.0f})",
    "lab_meaning_seen": "vue {n} fois",
    "lab_meaning_situation": "quand <b>{what}</b>",
    "lab_meaning_slight": "légère",
    "lab_meaning_title": "Que représente-t-il ?",
    "lab_meaning_unmistakable": "indubitable",
    "lab_meaning_up": "monte à {inside:.0f}",
    "lab_origin_evidence": "Les mesures à l'origine de ce diagnostic :",
    "lab_origin_title": "Pourquoi ce neurone existe-t-il ?",
    "lab_ov_cooldown": "Temps de recharge de la croissance : {left:.0f} s restantes",
    "lab_ov_deficits": "Ce que le cerveau ne sait pas encore faire",
    "lab_ov_no_deficits": "Rien. Le réseau peut représenter, réguler et exprimer tout ce qu'il a rencontré.",
    "lab_ov_ready": "prêt à faire croître la structure",
    "lab_ov_shrinking": "l'apprentissage ordinaire la réduit déjà",
    "lab_ov_stood_down": "N'a pas fait croître pour {deficit} : {why}",
    "lab_ov_watching": "en observation - {obs} observation(s), {age:.0f} s",
    "lab_reading_down": "un peu en dessous du repos",
    "lab_reading_high": "bien au-dessus de son niveau de repos",
    "lab_reading_low": "bien en dessous de son niveau de repos",
    "lab_reading_max": "aussi haut que possible",
    "lab_reading_min": "aussi bas que possible",
    "lab_reading_neutral": "au repos, n'apportant rien",
    "lab_reading_up": "un peu au-dessus du repos",
    "lab_rediagnose": "Relancer le diagnostic",
    "lab_role_action": "Une action que le calmar peut remarquer accomplir",
    "lab_role_action_which": " - il est actif dès que le calmar est en train de <b>{action}</b>",
    "lab_role_action_writer": "écrit à chaque tick par ce que fait le calmar, exactement comme un organe sensoriel est écrit par le monde",
    "lab_role_designed": "Un neurone ajouté dans le Concepteur",
    "lab_role_designed_writer": "calculé par le réseau à chaque tick à partir des synapses qui pointent vers lui",
    "lab_role_drive": "Une pulsion fondamentale - une partie du corps du calmar, pas de son réseau",
    "lab_role_drive_writer": "écrite par le modèle du calmar ; le réseau l'atteint par modulation, une petite poussée à chaque tick, jamais en l'écrasant",
    "lab_role_grown": "Un neurone que le calmar a fait croître lui-même",
    "lab_role_grown_writer": "calculé par le réseau à chaque tick à partir des synapses qui pointent vers lui",
    "lab_role_other": "Un neurone",
    "lab_role_sensor": "Un organe sensoriel",
    "lab_role_sensor_writer": "écrit à chaque tick par le monde ; rien de ce que fait le réseau ne peut le changer, et c'est pourquoi aucune synapse n'a le droit de pointer vers lui",
    "lab_tip_connector": "Généré par le réseau pour relier des neurones orphelins. Possède 3 connexions.",
    "learn_ltd": "⚡ DLT",
    "learn_ltp": "⚡ PLT",
    "learn_stdp_delta": "STDP Δ {delta} &nbsp;·&nbsp; mélange {blend} % temporisation des potentiels",
    "log_converted_neuron": "{name} converti en FunctionalNeuron",
    "log_emergency_context": "Contexte d'urgence détecté (Anxiété > 90)",
    "log_global_cap_bypass": "Dérogation d'urgence : la limite globale de neurones est ignorée !",
    "log_reason_weak": "connexions/activité faibles",
    "log_reciprocal_links": "Liens réciproques ajoutés",
    "log_strengthened_neuron": "Renforcé : {name} (multiplicateur : {mult}x)",
    "log_sync_complete": "Synchronisation de la neurogenèse terminée",
    "log_type_cap_reached": "Limite de type atteinte pour {type} ({count}/{max}), renforcement des neurones existants",
    "log_unknown_reason": "raison inconnue",
    "mem_behaviour": "Comportement",
    "mem_calmed_down": "S'est calmé",
    "mem_eating": "En train de manger",
    "mem_environment": "Environnement",
    "mem_favourite_plant": "Plante préférée",
    "mem_importance_label": "Importance :",
    "mem_ink_cloud": "Nuage d'encre !",
    "mem_interaction": "Interaction",
    "mem_less_space": "Moins d'espace",
    "mem_ltm_header": "c'est arrivé souvent...",
    "mem_mental_state": "État mental",
    "mem_more_space": "Plus d'espace !",
    "mem_picked_poop": "A ramassé un excrément",
    "mem_picked_poop_desc": "A ramassé un peu d'excrément…",
    "mem_picked_rock": "A ramassé un caillou",
    "mem_picked_rock_desc": "A ramassé un caillou",
    "mem_plant_calming": "Apaisement par la plante",
    "mem_plant_contact": "Contact avec une plante",
    "mem_plant_touched": "A touché {plant} – se sent plus calme",
    "mem_poop_throwing": "Lancer d'excréments",
    "mem_reduces_anxiety": "Réduit l'anxiété",
    "mem_rock_throwing": "Lancer de cailloux",
    "mem_startle_response": "Réaction de sursaut",
    "mem_startled": "Surpris !",
    "mem_urchin_throwing": "Lancer d'oursins",
    "neuron_name_format": "{type} : {spec}{suffix}",
    "nt_load_brain_state": "Charger l'état du cerveau",
    "nt_msg_designer_launch_fail": "Impossible de lancer le Concepteur de Cerveau.",
    "nt_no_buffer": "⚠️ Tampon d'expériences indisponible",
    "nt_save_brain_state": "Enregistrer l'état du cerveau",
    "preferences": "Préférences",
    "prov_note_bad": "quelque chose de mauvais est arrivé",
    "prov_note_good": "quelque chose de bon est arrivé",
    "prov_note_innate": "ce calmar est né avec",
    "prov_note_pruned": "{name} a été élagué pour connexions faibles et inactivité, ses synapses sont donc parties avec lui",
    "prov_note_reward": "{note}, et cette synapse se déclenchait dans le bon ordre juste avant",
    "show_tutorial_q": "Afficher le tutoriel ?",
    "startup": "Démarrage",
    "stat_max_neurons": "Neurones max",
    "stat_na": "N/D",
    "stat_none": "Aucune",
    "tab_knowledge": "Connaissances",
    "tooltip_experience_buffer": "Afficher les expériences dont le cerveau apprend",
    "tutorial_query": "Souhaitez-vous voir le tutoriel ?",
    "tutorial_title": "Tutoriel",

    # ===== BRAIN TOOL ASSOCIATIONS & MEMORY CARDS =====
    "bt_assoc_anxiety_cleanliness": "Être anxieux est {strength} associé à une moindre propreté",
    "bt_assoc_curiosity_happiness": "{name} est {strength} associé au bonheur",
    "bt_assoc_explanation": "Cet onglet montre les associations apprises entre les différents états neuronaux du calmar. Elles se forment par apprentissage hebbien, selon lequel « les neurones qui s'activent ensemble se connectent ensemble ». La force d'une association dépend de la fréquence à laquelle ces états surviennent ensemble ou s'influencent. Une association positive signifie que lorsqu'un état augmente, l'autre tend à augmenter aussi. Une association négative (indiquée par « moindre ») signifie que lorsqu'un état augmente, l'autre tend à diminuer. Ces associations aident à comprendre comment les expériences du calmar façonnent son comportement et ses décisions.",
    "bt_assoc_generic": "{name} est {strength} {relation} {other}",
    "bt_assoc_happiness_cleanliness": "Être heureux est {strength} associé à la propreté",
    "bt_assoc_happiness_curiosity": "Être heureux est {strength} associé à une curiosité accrue",
    "bt_assoc_hunger_anxiety": "{name} est {strength} associé à une anxiété accrue",
    "bt_assoc_hunger_satisfaction": "{name} est {strength} associé à la satisfaction (sans doute grâce aux repas)",
    "bt_assoc_moderately": "modérément",
    "bt_assoc_satisfaction_hunger": "Être satisfait est {strength} associé à une faim moindre",
    "bt_assoc_strongly": "fortement",
    "bt_assoc_with": "associé à",
    "bt_assoc_with_reduced": "associé à une moindre",
    "bt_being_anxious": "Être anxieux",
    "bt_being_clean": "Être propre",
    "bt_being_happy": "Être heureux",
    "bt_being_hungry": "Avoir faim",
    "bt_being_sleepy": "Avoir sommeil",
    "bt_btn_train_hebbian": "Entraîner (Hebb)",
    "bt_decision_line": "Décision : {decision}",
    "bt_direction": "Direction",
    "bt_export_tab_title": "Exporter le contenu de l'onglet Apprentissage",
    "bt_training_overview": "Aperçu du processus d'entraînement :\n\n1. Capture des données : lorsque « Capturer les données d'entraînement » est coché, l'état de tous les neurones est enregistré à chaque stimulation du cerveau.\n\n2. Apprentissage hebbien : le bouton « Entraîner (Hebb) » applique la règle d'apprentissage hebbien aux données capturées.\n\n3. Force d'association : l'apprentissage renforce les connexions entre neurones souvent actifs ensemble.\n\n4. Mise à jour des poids : après l'entraînement, les poids entre neurones sont actualisés selon leurs schémas de coactivation.\n\n5. Comportement adaptatif : avec le temps, le cerveau adapte ainsi son comportement aux schémas d'entrée.",
    "mem_ate_on_trip": "A mangé en voyage",
    "mem_calm_return": "Retour serein",
    "mem_decoration_exchange": "Échange de décoration",
    "mem_emotion": "Émotion",
    "mem_fear": "Peur",
    "mem_happy_return": "Retour joyeux",
    "mem_intense_curiosity": "Curiosité intense",
    "mem_journey_complete": "Voyage terminé",
    "mem_observation": "Observation",
    "mem_played_on_trip": "A joué en voyage",
    "mem_saw_rock_thrown": "A vu lancer un caillou",
    "mem_social": "Social",
    "mem_squid_detection": "A repéré un calmar",
    "mem_squid_lost": "A perdu le calmar de vue",
    "mem_squid_meeting": "A rencontré un autre calmar",
    "mem_targeted": "Visé par un caillou",
    "mem_travel": "Voyage",
    "mem_washed_clean": "Lavé de frais",
}
