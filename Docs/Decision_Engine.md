`DecisionEngine` calculates decision weights for potential actions based on neural states, memories, environmental conditions (such as visible objects) and personality traits. The highest-weighted action is executed
