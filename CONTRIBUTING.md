...
- Scenarios & Tools: Add example scenarios or utility scripts in example_squids/ or extras/. For example, share example saved states or scripts that demonstrate interesting behaviors or training setups.
...
- Documentation: Write Wiki pages, create tutorials. Clear documentation, examples, and screenshots help new users and contributors get up to speed. Update comments and docstrings in code as well.
